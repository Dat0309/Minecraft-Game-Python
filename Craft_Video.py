...
app = Ursina()
grass_texture = load_texture('resource/grass_block.png')
stone_texture = load_texture('resource/stone_block.png')
brick_texture = load_texture('resource/brick_block.png')
